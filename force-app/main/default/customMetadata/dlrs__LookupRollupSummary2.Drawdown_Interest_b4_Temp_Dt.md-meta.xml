...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Drawdown: Interest b4 Temp Dt</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Interest_up_to_Last_Repayment_b4_Temp_Dt__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Drawdown_Payment_Allocation__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Interest_Accrued_to_Transaction_Date__c</value>
    </values>
    <values>
        <field>dlrs__FieldToOrderBy__c</field>
        <value xsi:type="xsd:string">Transaction_Date__c</value>
    </values>
    <values>
        <field>dlrs__ParentObject__c</field>
        <value xsi:type="xsd:string">Drawdown__c</value>
    </values>
    <values>
        <field>dlrs__RelationshipCriteriaFields__c</field>
        <value xsi:type="xsd:string">Before_Temp_Payout_Date__c
Temp_Payout_Date__c
Transaction_Date__c</value>
    </values>
    <values>
        <field>dlrs__RelationshipCriteria__c</field>
        <value xsi:type="xsd:string">Before_Temp_Payout_Date__c = TRUE</value>
    </values>
    <values>
